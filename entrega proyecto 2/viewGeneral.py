...
class viewGeneral:
    ...
    def pedirId(self):
        id = st.number_input("Ingrese el id de la aeronave ",min_value= 1 ,step=1)
        return id

    def pedirId2(self):
        number = st.number_input("Ingrese el id de su usuario ", min_value=1, max_value=10)
        return number
    ...
    def marca(self):
        mar = st.selectbox("Selecciona la aerolinea  de tu vuelo",["ArgueFlight","GIAL Air","Latem","AC Air","AFGM"])
        return mar
